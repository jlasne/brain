...
| R5.5 | A brain holding zero concept files seeds directly: every concept in the first drop becomes a file. From the second drop on, candidates need 3 mentions. |
